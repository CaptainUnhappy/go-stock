...
func init() {
	db.Init("file:cleanup_stock_codes_test?mode=memory&cache=shared")
	db.Dao.Exec(`CREATE TABLE IF NOT EXISTS followed_stock (
		stock_code TEXT,
		name TEXT,
		cost_price REAL,
		volume INTEGER,
	...
	db.Dao.Exec(`CREATE TABLE IF NOT EXISTS group_stock_info (
